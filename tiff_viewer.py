...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.actions_to_menus(fileMenu, [openshort, save, setEditing, setMoving, quit])
        
        self.toolbar=QToolBar()
        self.toolbar.clear()
        [self.addbutton(self.toolbar, action) for action in [openshort, save, setEditing, setMoving, quit]]
