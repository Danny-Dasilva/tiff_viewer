...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.actions_to_menus(fileMenu, [openshort, save, setEditing, setMoving, setNavigating, setClosed, quit])
        
        self.toolbar=QToolBar()
        self.toolbar.clear()
        [self.addbutton(self.toolbar, action) for action in [openshort, save, setEditing, setMoving, setNavigating, setClosed, quit]]
    ...
    def saver(self):
        ...
        print(savepath)
        if savepath:
            return self.saveFile(filename=savepath[0], polygons=self.viewer.scene.polys, object_types=savepath)
